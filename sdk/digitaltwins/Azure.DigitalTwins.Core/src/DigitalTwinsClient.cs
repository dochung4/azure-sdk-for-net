...
namespace Azure.DigitalTwins.Core
{
    ...
    public class DigitalTwinsClient
    {
        ...
        /// <summary>
        /// Gets a digital twin asynchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Gets a digital twin synchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <remarks>
        /// The returned application/json string can always be deserialized into an instance of <see cref="Serialization.BasicDigitalTwin"/>.
        /// It may also be deserialized into custom digital twin types that extend the <see cref="Serialization.BasicDigitalTwin"/> with additional
        ...
        /// <summary>
        /// Creates a digital twin asynchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the digital twin.</param>
        ...
        /// <summary>
        /// Creates a digital twin synchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the digital twin.</param>
        /// <param name="digitalTwin">The application/json digital twin to create.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        ...
        /// <summary>
        /// Deletes a digital twin asynchronously. After the task completes response would be set to <see cref="Response"/>.
        /// </summary>
        ...
        /// <summary>
        /// Deletes a digital twin synchronously. After the task completes response would be set to <see cref="Response"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the digital twin to delete.</param>
        /// <param name="requestOptions">The optional settings for this request.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        ...
        /// <summary>
        /// Updates a digital twin asynchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Updates a digital twin synchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the digital twin to update.</param>
        /// <param name="digitalTwinUpdateOperations">The application/json-patch+json operations to be performed on the specified digital twin.</param>
        /// <param name="requestOptions">The optional settings for this request.</param>
        ...
        /// <summary>
        /// Gets a component on a digital twin asynchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the digital twin.</param>
        ...
        /// <summary>
        /// Gets a component on a digital twin synchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the digital twin.</param>
        /// <param name="componentPath">The component being retrieved.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        ...
        /// <summary>
        /// Updates properties of a component on a digital twin asynchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the digital twin.</param>
        ...
        /// <summary>
        /// Updates properties of a component on a digital twin synchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the digital twin.</param>
        /// <param name="componentPath">The component being modified.</param>
        /// <param name="componentUpdateOperations">The application/json-patch+json operations to be performed on the specified digital twin's component.</param>
        ...
        /// <summary>
        /// Gets all the relationships on a digital twin asynchronously. After the task completes response would be set to <see cref="AsyncPageable{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets all the relationships on a digital twin synchronously. After the task completes response would be set to <see cref="Pageable{T}"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the source digital twin.</param>
        /// <param name="relationshipName">The name of a relationship to filter to. If null, all relationships for the digital twin will be returned.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        ...
        /// <summary>
        /// Gets all the relationships referencing a digital twin as a target asynchronously. After the task completes response would be set to <see cref="AsyncPageable{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets all the relationships referencing a digital twin as a target synchronously. After the task completes response would be set to <see cref="Pageable{T}"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the target digital twin.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The pageable list of application/json relationships directed towards the specified digital twin and the http response.</returns>
        ...
        /// <summary>
        /// Gets a relationship on a digital twin asynchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the source digital twin.</param>
        ...
        /// <summary>
        /// Gets a relationship on a digital twin synchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the source digital twin.</param>
        /// <param name="relationshipId">The Id of the relationship to retrieve.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        ...
        /// <summary>
        /// Deletes a relationship on a digital twin asynchronously. After the task completes response would be set to <see cref="Response"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the source digital twin.</param>
        ...
        /// <summary>
        /// Deletes a relationship on a digital twin synchronously. After the task completes response would be set to <see cref="Response"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the source digital twin.</param>
        /// <param name="relationshipId">The Id of the relationship to delete.</param>
        /// <param name="requestOptions">The optional settings for this request.</param>
        ...
        /// <summary>
        /// Creates a relationship on a digital twin asynchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the source digital twin.</param>
        ...
        /// <summary>
        /// Creates a relationship on a digital twin synchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the source digital twin.</param>
        /// <param name="relationshipId">The Id of the relationship to delete.</param>
        /// <param name="relationship">The application/json relationship to be created.</param>
        ...
        /// <summary>
        /// Updates the properties of a relationship on a digital twin asynchronously. After the task completes response would be set to <see cref="Response"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the source digital twin.</param>
        ...
        /// <summary>
        /// Updates the properties of a relationship on a digital twin synchronously. After the task completes response would be set to <see cref="Response"/>.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the source digital twin.</param>
        /// <param name="relationshipId">The Id of the relationship to be updated.</param>
        /// <param name="relationshipUpdateOperations">The application/json-patch+json operations to be performed on the specified digital twin's relationship.</param>
        ...
        /// <summary>
        /// Gets the list of models asynchronously. After the task completes response would be set to <see cref="AsyncPageable{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the list of models synchronously. After the task completes response would be set to <see cref="Pageable{T}"/>.
        /// </summary>
        /// <param name="dependenciesFor">The model Ids to have dependencies retrieved.</param>
        /// <param name="includeModelDefinition">Whether to include the model definition in the result. If false, only the model metadata will be returned.</param>
        /// <param name="options">The options to follow when listing the models. For example, the page size hint can be specified.</param>
        ...
        /// <summary>
        /// Gets a model, including the model metadata and the model definition asynchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets a model, including the model metadata and the model definition synchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <param name="modelId">The Id of the model.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The application/json model and the http response.</returns>
        ...
        /// <summary>
        /// Decommissions a model asynchronously. After the task completes response would be set to <see cref="Response"/>.
        /// </summary>
        ...
        /// <summary>
        /// Decommissions a model synchronously. After the task completes response would be set to <see cref="Response"/>.
        /// </summary>
        /// <param name="modelId">The Id of the model to decommission.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The http response.</returns>
        ...
        /// <summary>
        /// Creates one or many models asynchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates one or many models synchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <param name="models">The set of models to create. Each string corresponds to exactly one model.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The created models and the http response.</returns>
        ...
        /// <summary>
        /// Deletes a model asynchronously. After the task completes response would be set to <see cref="Response"/>.
        /// </summary>
        ...
        /// <summary>
        /// Deletes a model synchronously. After the task completes response would be set to <see cref="Response"/>.
        /// </summary>
        /// <param name="modelId"> The id for the model. The id is globally unique and case sensitive. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <remarks>
        ...
        /// <summary>
        /// Queries for digital twins asynchronously. After the task completes response would be set to <see cref="AsyncPageable{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Queries for digital twins synchronously. After the task completes response would be set to <see cref="Pageable{T}"/>.
        /// </summary>
        /// <param name="query">The query string, in SQL-like syntax.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The pageable list of query results.</returns>
        ...
        /// <summary>.
        /// Lists the event routes in a digital twins instance asynchronously. After the task completes response would be set to <see cref="AsyncPageable{T}"/>.
        /// </summary>
        ...
        /// <summary>.
        /// Lists the event routes in a digital twins instance synchronously. After the task completes response would be set to <see cref="Pageable{T}"/>.
        /// </summary>
        /// <param name="options">The options to use when listing the event routes. One can set the maximum number of items to retrieve per request, however the service may return less than requested.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>A pageable set of application/json event routes and the http response.</returns>
        ...
        /// <summary>
        /// Gets an event route by Id asynchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets an event route by Id synchronously. After the task completes response would be set to <see cref="Response{T}"/>.
        /// </summary>
        /// <param name="eventRouteId">The Id of the event route.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The application/json event routes and the http response.</returns>
        ...
        /// <summary>
        /// Creates an event route asynchronously. After the task completes response would be set to <see cref="Response"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates an event route synchronously. After the task completes response would be set to <see cref="Response"/>.
        /// </summary>
        /// <param name="eventRouteId">The Id of the event route to create.</param>
        /// <param name="eventRoute">The event route data containing the endpoint and optional filter.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        ...
        /// <summary>
        /// Deletes an event route asynchronously. After the task completes response would be set to <see cref="Response"/>.
        /// </summary>
        ...
        /// <summary>
        /// Deletes an event route synchronously. After the task completes response would be set to <see cref="Response"/>.
        /// </summary>
        /// <param name="eventRouteId">The Id of the event route to delete.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The http response.</returns>
        ...
        /// <summary>
        /// Publishes telemetry from a digital twin asynchronously. After the task completes response would be set to <see cref="Response"/>.
        ...
        /// <summary>
        /// Publishes telemetry from a digital twin synchronously. After the task completes response would be set to <see cref="Response"/>.
        /// The result is then consumed by one or many destination endpoints (subscribers) defined under <see cref="EventRoute"/>.
        /// These event routes need to be set before publishing a telemetry message, in order for the telemetry message to be consumed.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the digital twin.</param>
        ...
        /// <summary>
        /// Publishes telemetry from a digital twin's component asynchronously. After the task completes response would be set to <see cref="Response"/>.
        /// The result is then consumed by one or many destination endpoints (subscribers) defined under <see cref="EventRoute"/>.
        /// These event routes need to be set before publishing a telemetry message, in order for the telemetry message to be consumed.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the digital twin.</param>
        ...
        /// <summary>
        /// Publishes telemetry from a digital twin's component synchronously. After the task completes response would be set to <see cref="Response"/>.
        /// The result is then consumed by one or many destination endpoints (subscribers) defined under <see cref="EventRoute"/>.
        /// These event routes need to be set before publishing a telemetry message, in order for the telemetry message to be consumed.
        /// </summary>
        /// <param name="digitalTwinId">The Id of the digital twin.</param>
